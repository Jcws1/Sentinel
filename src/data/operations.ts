...
export type TaskStatus = 'review' | 'executing' | 'completed' | 'held' | 'rejected'
...
export const INTERCEPT_DURATIONS_MS = { single: 8_500, coastal: 14_000 } as const
...
export const TRACKS: OperationalTrack[] = [
  ...
  { id: 'THALES-01', affiliation: 'hostile', threatClass: 'I', speedKmh: 360, altitudeM: 362, bearingDeg: 180, rangeM: 1400, headingDeg: 0, etaSeconds: 14, confidence: 96, sensors: ['THALES-GM200-TRN'], ageSeconds: 1, action: 'Intercept' },
...
export const INITIAL_TASKS: MissionTask[] = [
  ...
  { id: 'TASK-WGT-01', trackId: 'THALES-01', objective: 'Intercept', assetIds: ['WGT-BOX-1'], etaSeconds: 14, confidence: 96, status: 'review', policy: 'within', rationale: 'Routes the recorded GM200 training track through the Wedgetail adapter and visualises the defensive response locally.', adapter: 'wedgetail-sandbox', launchBoxId: 'box_1' },
  { id: 'TASK-WGT-SPLIT', trackId: 'THALES-SPLIT-04', objective: 'Littoral intercept', assetIds: ['BOX-1', 'BOX-2', 'BOX-3'], etaSeconds: 20, confidence: 94, status: 'review', policy: 'within', rationale: 'Routes four recorded littoral tracks across three launch boxes and visualises the coordinated defensive response locally.', adapter: 'wedgetail-sandbox', launchBoxId: 'box_1' },
...
export const SENSOR_SOURCES = [
  ...
  { id: 'THALES-GM200-TRN', name: 'Thales radar training feed', product: 'Recorded target track', state: 'nominal', freshness: '1 s', delivery: 'training' },
] as const

export const SCENARIOS = [
  { id: 'SCN-COAST', name: 'Thales coastal split', context: 'SwarmBreakers 04 · perp_dive_split_180_20_100', forces: '~300 estimated drones · 3 interceptors', duration: 'Split window · 14 s training run', state: 'ready' },
  ...
  { id: 'SCN-03', name: 'Thales training feed', context: 'Recorded radar input', forces: '120 generated objects', duration: '33 min', state: 'running' },
  { id: 'SCN-04', name: 'Positioning fallback', context: 'Reduced-positioning test', forces: '12 training aircraft', duration: '6 min', state: 'ready' },
] as const
