...
from app.commands.legacy_d3a import LegacyD3aMovePosition as MovePosition, LegacyD3aCompletionSample as CompletionSample
from app.scenarios.actions import ScheduledAction, validate_chain


class LegacyD3aSourceMotion(Model):
    id: Id
    origin: MovePosition
...
class LegacyD3aScheduledExecution(Model):
    ...
    motion: LegacyD3aSourceMotion | None = None
...
class LegacyD3aScenarioSchedule(Model):
    ...
    actions: list[LegacyD3aScheduledExecution] = Field(max_length=128)
