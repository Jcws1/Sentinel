...
def exports() -> dict[str, dict]:
    ...
    frame.update(schemaVersion="1.1", frameId="fixture-frame-0", recordingId="fixture-recording-alpha", streamEpoch="fixture-epoch-alpha",
...
def main():
    ...
    output = ROOT / "contracts" / "sentinel" / "v1.1"
    failures = []
